                                                                ...
                                                                <table class="table mb-5">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="d-flex justify-content-center">                                                                                
                                                                                    <x-jet-input class="text-center" id="ajuste"  type="number" name="ajuste" autocomplete="off" min="{{$articulo->Stock_disponible}}*(-1)" max="0" value="0" autofocus required></x-jet-input>
                                                                                </div> 
                                                                            </td>                                                                 
                                                                      </tr>                                                                                                                       
                                                                    </tbody>
