...
//mostrar datos de la Solicitud de Compra
<div class="container h-auto mx-auto mt-4">
    <div class="row">
      ...
      <div class="col-sm-4 overflow-hidden shadow-md sm:rounded-lg bg-white">  
          <h3 class="text-center">Solicitud de Compra:N° {{$solicitud->SolicitudCompraID}}</h3>
          <p class="text-center">Fecha Registro:{{$fechareg}}</p> 
      </div> 
    </div> 
  </div>
...
<div class="container h-auto mx-auto mt-2">
  <div class="d-flex justify-content-center"> 
      <a class="btn btn-primary" href="{{route('compras.solicitudCompras')}}" role="button">Alta de Solicitud de Compra</a>
  </div>
  ...
  <div class="container h-auto mx-auto mt-2">
  <div class="d-flex justify-content-center"> 
      <a class="btn btn-primary" href="{{}}" role="button">Eliminar Seleccionados</a>
  </div> 
  ...
  <div class="container h-auto sm:rounded-md shadow-md mx-auto mt-2 p-2 bg-white">
      <table id="example" class="table table-hover table-bordered" style="width:100%">
          ...
          @foreach ($detalles as $d) 
              <tr>            
                  <td> Eliminar</td>    
                  <td class="text-center">{{$d->AritculoID}}</td>
