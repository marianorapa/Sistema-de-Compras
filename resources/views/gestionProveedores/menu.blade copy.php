...
<x-slot name="header">
        <h2 class="font-bold text-xl text-blue-800 leading-tight">
            {{ __('Menú de Proveedores') }}
        </h2>
</x-slot>

    <div class="container mx-auto py-2 mt-3">
        <div class="flex items-center justify-center mb-3">
            <a href="{{route('proveedor.alta')}}" class="btn btn-success bg-blue-500 text-white font-bold px-2 py-1 rounded-lg  hover:bg-blue-700">Alta de Proveedor</a>
        </div>
