            ...
            <div class="w-1/3 p-4 bg-gray-100">                
                <div class="text-gray-700 text-center bg-gray-100 p-4">                   
                    ...
                    <div class="max-w-sm rounded overflow-hidden shadow-lg pb-10">                        
                        ...
                        <div class="px-6 py-4">                         
                        <a href="{{ route('inventario.puntoPedido','puntoPedido') }}" class="btn btn-success  bg-gray-300 text-gray-600 font-bold px-2 py-1 rounded-lg  hover:bg-gray-500 hover:text-white">Establecer punto de pedido</a>                     
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="w-1/3 p-4 bg-gray-100">                
                <div class="text-gray-700 text-center bg-gray-100 p-4"> 
                    ...
                    <div class="max-w-sm rounded overflow-hidden shadow-lg pb-10">                        
                        ...
                        <div class="px-6 py-4">
                        <a href="{{ route('inventario.ajustarInventario','ajustarInventario') }}" class="btn btn-success  bg-gray-300 text-gray-600 font-bold px-2 py-1 rounded-lg  hover:bg-gray-500 hover:text-white">Ajustar inventario</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="w-1/3 p-4 bg-gray-100">                
                <div class="text-gray-700 text-center bg-gray-100 p-4"> 
                    ...
                    <div class="max-w-sm rounded overflow-hidden shadow-lg pb-10">                        
                        ...
                        <div class="px-6 py-4">
                        <a href="{{ route('inventario.registrarArticulo','registrarArticulo') }}" class="btn btn-success  bg-gray-300 text-gray-600 font-bold px-2 py-1 rounded-lg  hover:bg-gray-500 hover:text-white">Registrar artículos recibídos</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="w-1/3 p-4 bg-gray-100">                
                <div class="text-gray-700 text-center bg-gray-100 p-4"> 
                    ...
                    <div class="max-w-sm rounded overflow-hidden shadow-lg pb-10">                        
                        ...
                        <div class="px-6 py-4">
                        <a href="{{ route('inventario.verificarInventario','verificarInventario') }}" class="btn btn-success  bg-gray-300 text-gray-600 font-bold px-2 py-1 rounded-lg  hover:bg-gray-500 hover:text-white">Verificar inventario</a>                       
                        </div>
                    </div>
                </div>
            </div>
